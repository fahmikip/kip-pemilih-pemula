...
const files=['AdminService.gs','SchoolService.gs','RewardService.gs','ReportService.gs'];
...
assert.match(admin,/getAdminDashboard/);assert.match(admin,/setParticipantStatus/);assert.match(admin,/createSchool/);assert.match(admin,/createSeason/);assert.match(admin,/createQuestion/);assert.match(admin,/finalizeWinner/);assert.match(admin,/updateRewardStatus/);assert.match(admin,/scanFraudSignals/);assert.match(admin,/reviewFraudCase/);assert.match(admin,/getReportPreview/);assert.match(admin,/exportReportCsv/);
