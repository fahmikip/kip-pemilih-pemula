...
const app=fs.readFileSync('pwa/app.js','utf8');assert.match(app,/beforeinstallprompt/);assert.match(app,/hostname==='script\.google\.com'/,'launcher hanya menerima host Apps Script resmi');
